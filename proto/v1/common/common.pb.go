...
type StreamError struct {
	...
	Code          ErrorCode              `protobuf:"varint,1,opt,name=code,proto3,enum=market.common.v1.ErrorCode" json:"code,omitempty"`
...
type Pagination struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	PageSize      int32                  `protobuf:"varint,1,opt,name=page_size,json=pageSize,proto3" json:"page_size,omitempty"`   // Maximum number of items to return
	PageToken     string                 `protobuf:"bytes,2,opt,name=page_token,json=pageToken,proto3" json:"page_token,omitempty"` // Token for the next page
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type ListSymbolsResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Symbols       []string               `protobuf:"bytes,1,rep,name=symbols,proto3" json:"symbols,omitempty"`                                    // Available trading symbols
	NextPageToken string                 `protobuf:"bytes,2,opt,name=next_page_token,json=nextPageToken,proto3" json:"next_page_token,omitempty"` // Token for next page of symbols
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
var file_common_common_proto_rawDesc = string([]byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x10, 0x6d, 0x61, 0x72, 0x6b, 0x65, 0x74, 0x2e, 0x63, 0x6f,
	0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x76, 0x31, 0x22, 0x58, 0x0a, 0x0b, 0x53, 0x74, 0x72, 0x65, 0x61,
	0x6d, 0x45, 0x72, 0x72, 0x6f, 0x72, 0x12, 0x2f, 0x0a, 0x04, 0x63, 0x6f, 0x64, 0x65, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x0e, 0x32, 0x1b, 0x2e, 0x6d, 0x61, 0x72, 0x6b, 0x65, 0x74, 0x2e, 0x63, 0x6f,
	...
	0x52, 0x09, 0x70, 0x61, 0x67, 0x65, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0x52, 0x0a, 0x12, 0x4c,
	...
	0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1c, 0x2e, 0x6d, 0x61, 0x72, 0x6b, 0x65, 0x74, 0x2e, 0x63,
	...
	,
	...
	,
...
var file_common_common_proto_goTypes = []any{
	(ErrorCode)(0),              // 0: market.common.v1.ErrorCode
	(AggregationInterval)(0),    // 1: market.common.v1.AggregationInterval
	(*StreamError)(nil),         // 2: market.common.v1.StreamError
	(*Pagination)(nil),          // 3: market.common.v1.Pagination
	(*ListSymbolsRequest)(nil),  // 4: market.common.v1.ListSymbolsRequest
	(*ListSymbolsResponse)(nil), // 5: market.common.v1.ListSymbolsResponse
}
var file_common_common_proto_depIdxs = []int32{
	0, // 0: market.common.v1.StreamError.code:type_name -> market.common.v1.ErrorCode
	3, // 1: market.common.v1.ListSymbolsRequest.pagination:type_name -> market.common.v1.Pagination
	4, // 2: market.common.v1.CommonService.ListSymbols:input_type -> market.common.v1.ListSymbolsRequest
	5, // 3: market.common.v1.CommonService.ListSymbols:output_type -> market.common.v1.ListSymbolsResponse
